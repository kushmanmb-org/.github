...
1. **Transactions with Access Lists**:
   - Access list data costs **16 gas per token** (aligned with EIP-7976's updated value)
   - Previous floor cost was 10 gas per token (from EIP-7623)
   - This affects transactions that use access lists for gas optimization
   - Impact: **60% increase** in access list data costs compared to the EIP-7623 baseline
